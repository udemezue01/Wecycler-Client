    ...
    <form class="mt-8" action="#" method="POST">
      ...
      <div class="mt-6 flex items-center justify-between">
        ...
        <div class="text-sm leading-5">
          <a href="#" class="font-medium text-gray-700-100 hover:text-gray-700 focus:outline-none focus:underline transition ease-in-out duration-150">
      ...
      <div class="mt-6">
        <button type="submit" class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-green-100 hover:bg-green-100 focus:outline-none focus:border-green-100 focus:shadow-outline-indigo active:bg-green-100 transition duration-150 ease-in-out">
